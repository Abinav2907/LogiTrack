...
export default function DashboardPage() {
  ...
  const failedRoutes =
    dashboard?.activeRoutes.filter((route) => route.status === "Failed Attempt")
      .length ?? 0;
  const pendingRoutes =
    dashboard?.activeRoutes.filter((route) => route.status === "Pending")
      .length ?? 0;
            ...
            <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
              <div>
                ...
                <p className="text-neutral-400 mt-2 max-w-2xl">
                  ...
                  logistics operations running smoothly with actionable
                  insights.
                </p>
              </div>
